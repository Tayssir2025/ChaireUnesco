    ...
    <section class="hero-section" style="background-image: url('LandingPage/images/image1.jpg'); background-size: cover; background-position: center; padding: 200px 0;">
        <div class="container">
            <div class="hero-content">
               <h1 style="color: #F8F9FA; font-size: 4rem;" class="fw-bold justify-content: center; 
  align-items: center;  fade-in">À Propos</h1>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="hero-grid ">
                    <div class="hero-content fade-in">
                        <h1>Qu'est-ce qu'une chaire UNESCO ?</h1>
                        <p>Une Chaire UNESCO est une équipe dirigée par un établissement d'en- seignement supérieur ou de recherche qui collabore avec l'UNESCO à un projet visant à faire progresser les connaissances et la pratique dans un domaine de priorité commune et en lien avec les domaines de compé- tence de l'UNESCO, à savoir l'éducation, les sciences exactes et natu- relles, les sciences sociales et humaines, la culture et la communication.
                        </p>
                    </div>
        ...
        <section class="mission">
            <div class="container">
                <div class="mission-grid">
                    <div>
                        <h2 class="hero-title fade-in">Quelles missions pour la chaire de l'Université de la Manouba?
                        </h2>
                    </div>
                    <div class="mission-text">
                        <p>La chaire UNESCO de l'Université de la Manouba a pour mission de promouvoir un système intégré de recherche, d'enseignement et de formation, ainsi que l'engagement de la communauté et la communica- tion pour le développement durable en Afrique.</p>
                        <p>Elle facilite la collaboration entre chercheurs et personnel enseignant de l'UMA avec ceux d'autres institutions du pays et à travers le monde.
                        </p>
                    </div>
                </div>
            </div>
