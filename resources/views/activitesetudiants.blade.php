...
.navbar {
        ...
        .hero-img-1 {
            background: url('./LandingPage/images/5.jpg') center/cover;
            border-radius: 8px;
            grid-column: span 2;
            height: 180px;
        }
        ...
        .hero-img-2 {
            background: url('./LandingPage/images/6.jpg') center/cover;
            border-radius: 8px;
            height: 200px;
        }
    ...
    <section class="hero-section" style="background-image: url('LandingPage/images/image1.jpg'); background-size: cover; background-position: center; padding: 200px 0;">
        <div class="container">
            <div class="hero-content">
               <h1 style="color: #F8F9FA; font-size: 4rem;" class="fw-bold  fade-in">les Étudiants</h1>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="hero-grid ">
                    <div class="hero-content fade-in">
                        <h1>Mobiliser les étudiants pour le développement durable</h1>
                        <p>Le projet GRéEN UMA (Groupement d’Étudiants Engagés de l'UMA), soutenu par la Chaire UNESCO, a pour objectif de sensibiliser, impliquer et responsabiliser les étudiants des établissements membres de l’UMA autour des enjeux du développement durable. Ce club étudiant repose sur une gouvernance participative, avec la création d’antennes locales dans plusieurs institutions (ISCAE, ISAMM, ESSTED, ESCT).</p>
                        <p>Les étapes clés du projet sont :</p>
                        <ul class="styled-list">
                            <li>Septembre 2025 : création des antennes locales dans chaque établissement.</li>
                            <li>Novembre 2025 : préparation de l’assemblée générale.</li>
                            <li>Décembre 2025 : élection du bureau du club GRéEN UMA et lancement officiel du projet.</li>
                        </ul>
                        <p class ="text-start">Chaque antenne élira un référent local, participera à l'assemblée générale et préparera un rapport d’activité. Ce processus permettra aux étudiants d’agir ensemble et de faire entendre leur voix sur les questions locales et globales liées au développement durable.
                        </p>
                    </div>
        ...
        <section class="mission">
            <div class="container">
                <div class="mission-grid">
                    <div>
                        <h2 class="hero-title fade-in">Vers une génération d’étudiants acteurs du changement
                        </h2>
                    </div>
                    <div class="mission-text">
                        <p>GRéEN UMA vise à créer une culture d'engagement responsable dans le milieu universitaire. Cette initiative permet non seulement d'intégrer le développement durable dans la vie étudiante, mais aussi de former des futurs professionnels engagés et conscients des enjeux sociétaux.</p>
                        
                        <ul class="styled-list" >
                            <p>Les résultats attendus sont :</p>
                            <li>L’intégration du développement durable dans les activités extra-universitaires.</li>
                            <li>La mise en œuvre de projets concrets et innovants portés par les étudiants.</li>
                        <li>La coopération entre les institutions pour des actions durables.</li>
                        </ul>

                        <p>En rejoignant GRéEN UMA, les étudiants deviennent des acteurs de changement, capables de proposer des solutions innovantes aux défis environnementaux, sociaux et économiques de leur époque.
                        </p>
                    </div>
                </div>
            </div>
