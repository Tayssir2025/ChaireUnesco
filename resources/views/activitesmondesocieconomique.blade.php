    ...
    <section class="hero-section" style="background-image: url('LandingPage/images/image1.jpg'); background-size: cover; background-position: center; padding: 200px 0;">
        <div class="container">
            <div class="hero-content">
               <h1 style="color: #F8F9FA; font-size: 4rem;" class="fw-bold  fade-in">Le Monde Socio-Économique</h1>
            </div>
        </div>
    </section>
            ...
            <div class="container">
                <div class="hero-grid ">
                    <div class="hero-content fade-in">
                        <h1>Relier l’Université au monde socio-économique : Une dynamique RSO</h1>
                        <p>Former les acteurs économiques aux enjeux du développement durable</p>
                        <p>La Chaire UNESCO de l’UMA place la Responsabilité Sociétale des Organisations (RSO) au cœur de ses actions pour accompagner les transformations du tissu économique africain. </p>
                        <p>Pour cela, elle propose :</p>
                        <ul class="styled-list">
                            <li>Un parcours de formation continue en RSO, accessible en ligne, pour permettre aux entreprises, institutions et organisations africaines de se former aux enjeux du développement durable.</li>
                            <li>Une base de données collaborative, réunissant des diplômés engagés, des projets de recherche, et des initiatives RSO. Cette plateforme facilitera les liens entre le monde universitaire et les acteurs économiques, en favorisant la collaboration et l’innovation.</li>
                            <li>Des actions de renforcement des capacités, pour aider les organisations à intégrer concrètement la RSO dans leur stratégie, leur gouvernance et leur fonctionnement.</li>
                        </ul>
        ...
        <section class="mission">
            <div class="container">
                <div class="mission-grid">
                    <div>
                        <h2 class="hero-title fade-in">Un partenariat durable entre savoirs et économie</h2>
                    </div>
                    <div class="mission-text">
                        <p>L’objectif est clair : connecter les connaissances produites à l’université avec les besoins du terrain, en accompagnant les entreprises africaines dans leur transition responsable.</p>
                        <p>Cette collaboration permettra :</p>
                        <ul  class="styled-list">
                            <li>D’accélérer l’adoption des bonnes pratiques RSO</li>
                            <li>De valoriser les talents formés par les universités.</li>
                            <li>De soutenir une croissance inclusive et durable en Afrique.</li>
                        </ul>
                    </div>
                </div>
            </div>
