...
<head>
    ...
    <title>Les Politiques Publiques Et Les Sociétés</title>
...
.navbar {
      ...
      .bouton {
        ...
        .hero-img-1 {
            background: url('./LandingPage/images/40.jpeg') center/cover;
            border-radius: 8px;
            grid-column: span 2;
            height: 180px;
        }
        ...
        .hero-img-2 {
            background: url('./LandingPage/images/31.jpeg') center/cover;
            border-radius: 8px;
            height: 200px;
        }
...
<body>
            ...
            <div class="container">
                <div class="hero-grid ">
                    <div class="hero-content fade-in">
                        <h1>Politiques publiques et société</h1>
                        <p>Sensibiliser, diffuser et valoriser</p>
                        <p>La Chaire UNESCO de l’UMA agit pour rendre les connaissances accessibles à tous en Afrique :</p>
                        <ul class="styled-list">
                            <li>Organisation d’événements de vulgarisation autour du développement durable.</li>
                            <li>Création de circuits de valorisation et de nouveaux formats de diffusion innovants.</li>
                            <li>Renforcement des liens entre les institutions culturelles, littéraires, artistiques et techniques pour favoriser la créativité partagée.</li>
                        </ul>
        ...
        <section class="mission">
            <div class="container">
                <div class="mission-grid">
                    <div>
                        <h2 class="hero-title fade-in">Plaidoyer pour un enseignement supérieur de qualité</h2>
                    </div>
                    <div class="mission-text">
                        <p>La Chaire accompagne les décideurs publics et œuvre pour :</p>
                        <ul class="styled-list">
                            <li>Un enseignement supérieur accessible et de qualité en Afrique.</li>
                            <li>L’intégration des Objectifs de Développement Durable (ODD) dans les politiques éducatives et sociales.</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <footer class="footer-section">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4">
                    <h4 class="footer-title">Les Politiques Publiques Et Les Sociétés</h4>
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a class="{{ request()->routeIs('about') ? 'active' : '' }}" href="{{ route('about') }}">Les Politiques Publiques Et Les Sociétés</a></li>
