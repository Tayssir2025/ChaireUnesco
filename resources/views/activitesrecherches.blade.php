...
<head>
    ...
    <title>La Recherche Et Le Progrès Scientifique</title>
...
.navbar {
        ...
        .hero-img-1 {
            background: url('./LandingPage/images/14.jpeg') center/cover;
            border-radius: 8px;
            grid-column: span 2;
            height: 180px;
        }
        ...
        .hero-img-2 {
            background: url('./LandingPage/images/16.jpeg') center/cover;
            border-radius: 8px;
            height: 200px;
        }
