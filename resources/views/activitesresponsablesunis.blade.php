...
<body>
    ...
    <section class="hero-section" style="background-image: url('LandingPage/images/image1.jpg'); background-size: cover; background-position: center; padding: 200px 0;">
        <div class="container">
            <div class="hero-content">
               <h1 style="color: #F8F9FA; font-size: 4rem;" class="fw-bold  fade-in">Les Responsables Universitaires</h1>
            </div>
        </div>
    </section>
     <main>
            ...
            <div class="container">
                <div class="hero-grid ">
                    <div class="hero-content fade-in">
                        <h1>Responsables universitaires : Vers des universités plus engagées</h1>
                        <p>Des campus connectés à leur territoire</p>
                        <p>La Chaire UNESCO de l’UMA s’engage à renforcer le rôle sociétal des universités africaines en promouvant une Responsabilité Sociétale des Universités (RSU) concrète et partagée. </p>
                        <p>Parmi les initiatives clés :</p>
                        <ul class="styled-list">
                            <li>Dialogues ouverts avec la communauté locale : pour co-construire des solutions liées à l’aménagement des espaces publics et à la mobilité douce autour de l’UMA.</li>
                            <li>Actions concrètes d’amélioration des campus : vers des lieux d’étude plus durables, inclusifs et accessibles.</li>
                        </ul>
        ...
        <section class="mission">
            <div class="container">
                <div class="mission-grid">
                    <div>
                        <h2 class="hero-title fade-in">Former, structurer, diffuser les bonnes pratiques</h2>
                    </div>
                    <div class="mission-text">
                        <p>Pour soutenir cette transformation institutionnelle, la chaire propose :</p>
                        <ul class="styled-list">
                            <li>Des ateliers de formation sur la RSU : pour accompagner les cadres universitaires à intégrer la responsabilité sociétale dans la gouvernance des établissements.</li>
                            <li>Des sessions de renforcement des capacités : visant à structurer l’engagement sociétal des universités à l’échelle africaine.</li>
                            <li>L’édition d’un livre blanc : rassemblant et valorisant les meilleures pratiques RSU menées dans les universités partenaires.</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <footer class="footer-section">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-4">
                    <h4 class="footer-title">La Recherche Et Le Progrès Scientifique</h4>
